...
#ifndef NET_MESSAGE_LOOP_MESSAGE_PUMP_LIBEVENT2_H_
#define NET_MESSAGE_LOOP_MESSAGE_PUMP_LIBEVENT2_H_
...
class MessagePumpLibevent2 : public MessagePump {
 public:
  class IOObserver {
   public:
    IOObserver() {}
  ...
  class FileDescriptorWatcher {
   ...
   private:
    ...
    friend class MessagePumpLibevent2Test;
    ...
    MessagePumpLibevent2* pump() const { return pump_; }
